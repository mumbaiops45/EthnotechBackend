...
exports.notifyStudents = async (students, subject, message) => {
  for (const student of students) {
    await exports.sendInApp(student._id, message);
    if (student.email)  await exports.sendEmail(student.email, subject, message);
